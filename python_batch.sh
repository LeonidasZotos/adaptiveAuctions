...
do
    # Loop through intersection_reward
    ...
    do
        ...
        do
            ...
            command="python3 aatc.py run --num_of_simulations 500 --grid_size 7 --num_of_epochs 2000 --congestion_rate=$var1 --intersection_reward=$var2 --auction_modifier_type=$var3"
