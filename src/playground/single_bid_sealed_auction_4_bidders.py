"""This is horrible code. I know. I'm sorry. I just wanted to get it done quickly. I'll clean it up later. I promise."""
import numpy as np
import random
...
def run_simulation(reserve):
    ...
    bidders = [Bidder(v_bidder1, a_bidder1, valuations_min_max, aversions_min_max, mu_a, sigma_a), Bidder(
        ...
        Bidder(v_bidder3, a_bidder3, valuations_min_max, aversions_min_max, mu_a, sigma_a), Bidder(v_bidder4, a_bidder4, valuations_min_max, aversions_min_max, mu_a, sigma_a)]
